...
#define HNS_FAMILY_GYM_WATER_START                  0x496
#define FLAG_FAMILY_GYM_WATER_VIOLET                (HNS_FAMILY_GYM_WATER_START + 0)
#define FLAG_FAMILY_GYM_WATER_AZALEA                (HNS_FAMILY_GYM_WATER_START + 1)
#define FLAG_FAMILY_GYM_WATER_GOLDENROD             (HNS_FAMILY_GYM_WATER_START + 2)
#define FLAG_FAMILY_GYM_WATER_ECRUTEAK              (HNS_FAMILY_GYM_WATER_START + 3)
#define FLAG_FAMILY_GYM_WATER_CIANWOOD              (HNS_FAMILY_GYM_WATER_START + 4)
#define FLAG_FAMILY_GYM_WATER_OLIVINE               (HNS_FAMILY_GYM_WATER_START + 5)
#define FLAG_FAMILY_GYM_WATER_MAHOGANY              (HNS_FAMILY_GYM_WATER_START + 6)
#define FLAG_FAMILY_GYM_WATER_BLACKTHORN            (HNS_FAMILY_GYM_WATER_START + 7)
#define FLAG_FAMILY_GYM_WATER_PEWTER                (HNS_FAMILY_GYM_WATER_START + 8)
#define FLAG_FAMILY_GYM_WATER_CERULEAN              (HNS_FAMILY_GYM_WATER_START + 9)
#define FLAG_FAMILY_GYM_WATER_VERMILION             (HNS_FAMILY_GYM_WATER_START + 10)
#define FLAG_FAMILY_GYM_WATER_CELADON               (HNS_FAMILY_GYM_WATER_START + 11)
#define FLAG_FAMILY_GYM_WATER_FUCHSIA               (HNS_FAMILY_GYM_WATER_START + 12)
#define FLAG_FAMILY_GYM_WATER_SAFFRON               (HNS_FAMILY_GYM_WATER_START + 13)
#define FLAG_FAMILY_GYM_WATER_SEAFOAM               (HNS_FAMILY_GYM_WATER_START + 14)
#define FLAG_FAMILY_GYM_WATER_VIRIDIAN              (HNS_FAMILY_GYM_WATER_START + 15)
#define HNS_FAMILY_GYM_WATER_COUNT                  16
#define HNS_FAMILY_GYM_WATER_END                    (HNS_FAMILY_GYM_WATER_START + HNS_FAMILY_GYM_WATER_COUNT - 1)
