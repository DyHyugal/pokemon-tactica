...
- [Contrat Tactica]()
    - [BOSSES_AI](spec/BOSSES_AI.md)
    - [CODEX_START](spec/CODEX_START.md)
    - [ENCOUNTERS](spec/ENCOUNTERS.md)
    - [FEATURE_STATUS](spec/FEATURE_STATUS.md)
    - [GAME_SYSTEMS](spec/GAME_SYSTEMS.md)
    ...
    - [SHOPS](spec/SHOPS.md)
    - [SOURCE_OF_TRUTH](spec/SOURCE_OF_TRUTH.md)
    - [STARTERS_RIVAL_EVOLUTIONS](spec/STARTERS_RIVAL_EVOLUTIONS.md)
    - [STATUS_AT_IMPORT](spec/STATUS_AT_IMPORT.md)
