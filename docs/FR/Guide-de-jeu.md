...
[Accueil](Accueil.md) · [Guide de jeu](Guide-de-jeu.md) · [Changements](Changements.md) · [Boss & Conseils](Boss-et-Conseils.md) · [Pokédex](Pokedex.md) · [Localisations](Localisations.md) · [Crédits & Versions](Credits-et-Versions.md) · **[EN](../EN/Game-Guide.md)**

# Guide de jeu

## Difficulté

Pokémon Tactica démarre en **HARD par défaut**. Le mode **NORMAL** reste disponible et propose lui aussi l'expérience Tactica complète.

### HARD
- équipes et sets Tactica ;
- IV = 31 sur les boss ;
- EV explicites adaptés aux rôles ;
- IA HARD et heuristiques Tactica ;
- synergies météo, terrains, screens, Trick Room, hazards, setup et pivots selon les boss.

### NORMAL
- **mêmes nouvelles équipes et sets Tactica** ;
...
NORMAL est donc une version moins optimisée de Tactica, pas un mode vanilla HnS.

## Paramètres

Le menu Tactica est organisé autour de six onglets :
- **Mode**
- **Features**
- **Randomizer**
- **Nuzlocke**
...
Pour les apparitions des dirigeants Team Rocket, la règle Tactica est dynamique : **chaque Pokémon du boss Rocket est au niveau du dernier cap canonique Champion/rival jalon +2**. Plusieurs boss Rocket sans nouveau jalon restent à ce même niveau.
